 ...
 * Schließlich gibt es die AltGr-Taste (¤ in obigem Bild) nun zwei Mal, sodass sich auf allen Tasten eine dritte Belegung (neben Shift und nicht-Shift) ergibt, die im gemütlichen Layout mehrfach genutzt wird: 
